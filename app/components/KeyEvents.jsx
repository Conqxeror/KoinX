  ...
  return (
    <div className='w-full overflow-hidden relative'>
      <div className='gap-3 h-40 flex md:overflow-x-hidden overflow-x-auto' ref={containerRef}>
        <div className='bg-blue-300 w-2/3 flex-shrink-0 flex gap-1 rounded-md p-3'>
          <div className='w-32 h-fit bg-blue-500 rounded-full p-2'>
            <Image src={news} width={300} height={300} />
          </div>
          <div className='flex flex-col'>
            <div className='font-semibold overflow-hidden overflow-ellipsis'>
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Adipisci eos assumenda magni minus
            </div>
            <div className='text-gray-800 overflow-hidden overflow-ellipsis'>
        ...
        <div className='bg-green-300 w-2/3 flex-shrink-0 flex gap-1 rounded-md p-3'>
