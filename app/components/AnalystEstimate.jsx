...
function Estimate({ label, percentage, color }) {
  ...
  return (
    <div className='flex w-full items-center gap-2 mt-2'>
      <div className='flex-shrink-0 sm:pr-2 text-xs' style={{ width: '40px' }}>{label}</div> 
      <div className='flex flex-grow items-center gap-1 sm:gap-3'>
        <div className={`h-2 sm:h-3 ${progressBarColorClass} rounded-full`} style={{ width: `${percentage}%` }}></div> 
